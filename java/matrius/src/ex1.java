...
//                }
//                case 8 -> {
//                    int entrada_col, entrada_fila, suma = 0;
...
//                    do {
//
//                    System.out.println("introdueix un valor entre el 4  el 8 per crear la columna :");
//                    entrada_col = sc.nextInt();
//                    System.out.println("introdueix un valor entre el 4  el 8 per crear la columna :");
//                    entrada_fila = sc.nextInt();
//
//                    int matriu8[][] = new int[entrada_fila][entrada_col];
//
//                    if (entrada_col < 4 || entrada_col > 8 || entrada_fila < 4 || entrada_fila > 8) {
//                        comprovant = false;
//                        System.out.println("Dada incorrecta");
//                    } else {
//                        for (int fila = 0; fila < matriu8.length; fila++) {
//                            for (int columna = 0; columna < matriu8[fila].length; columna++) {
//                                int valorandom = (int)(Math.random()*10 +1);
//                                suma += valorandom;
//                                matriu8[fila][columna] = valorandom;
//                                System.out.print(matriu8[fila][columna] + " ");
//                            }
//                            System.out.println();
//                        }
//                        System.out.println("la suma de la matriu es: " + suma);
//                        continua = sc.nextInt();
//
//                    }
//                    }while (!comprovant);
...
//                }
//                case 9 -> {
//                    int matriu9[][], entrada, valorrandom, numero_actual = 0;
//                    boolean comprovant = true;
//
//                    System.out.println("venvimgut a la opcio 9");
//
//                    do {
//                        System.out.println("Introdueix un numero del 2 al 10");
//                        entrada = sc.nextInt();
//
//                        matriu9 = new int[entrada][entrada];
//
//                        if (entrada < 2 || entrada > 10) {
//                            System.out.println("dada incorrecta");
//                            comprovant = false;
//                        } else {
//                            for (int fila = 0; fila < matriu9.length; fila++) {
//                                for (int columna = 0; columna < matriu9[fila].length; columna++) {
//                                    matriu9[fila][columna] = valorrandom = (int) (Math.random() * 100 + 1);
//                                    System.out.print(matriu9[fila][columna] + " ");
//                                }
//
//                                matriu9[0][0] = numero_actual;
//                                for (int i = 0; i < matriu9.length; i++) {
//                                    if (numero_actual == matriu9[i][j]);
//
//                                }
//                                System.out.println();
//                            }
...
//                }
//                case 0 -> {
//                    System.out.println("Has triat l'opcio 0: sotint del programa");
//                }
//
//            }
//        }
